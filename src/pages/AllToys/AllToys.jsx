        ...
        <Container>
            <div className='pt-16 px-2 md:px-5'>
                ...
                <div data-aos="fade-up"
                    data-aos-duration="3000" className='flex flex-col items-center my-16 text-rose-500'>
                    <h2 className='text-3xl style '>All Toys are Here <span className='text-5xl text-rose-500'>{toys.length}</span></h2>
                    <hr className='w-1/3' />
                </div>
                {/* search */}
...

                {
                    !isLoading ? <div className="overflow-x-auto md:overflow-hidden w-full mt-5 mb-10"><table className="table w-full">
                        ...
                        {
                            filteredToys.length === 0 ? <div className='relative z-40'><Loader/> </div>: (
                ...
                <div className='flex items-center justify-center my-16 style'>
                    <button className='text-white py-3 px-6 rounded-sm bg-rose-500 hover:bg-rose-600 border-none flex items-center gap-4' onClick={loadMoreToys}>
