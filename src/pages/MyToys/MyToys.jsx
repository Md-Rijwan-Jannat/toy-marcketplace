        ...
        <Container>
            <div className='pt-16 px-2 md:px-5'>
                ...
                <div data-aos="fade-up"
                    data-aos-duration="3000" className='flex flex-col items-center py-16 text-rose-500'>
                    <h2 className='text-3xl style '>All Toys are Here <span className='text-5xl text-rose-500'>{myToys.length}</span></h2>
                    <hr className='w-1/3' />
                </div>
                {
