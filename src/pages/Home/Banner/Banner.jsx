  ...
  return (
   <Container>
    ...
    >
      ...
      <div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-[700px] lg:items-center lg:px-8">
        <div className="max-w-xl text-center lg:text-start ltr:sm:text-left rtl:sm:text-right">
