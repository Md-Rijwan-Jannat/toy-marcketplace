            ...
            <div className="carousel h-full w-1/2 absolute right-0 top-0">
                <div id="slide1" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex justify-center left-5 right-5 bottom-5">
                        <h2 className='bg-gradient-to-r from-blue-300 to-fuchsia-500 px-10 py-1 text-4xl font-mono brightness-50 text-white font-extrabold'>Sports cars</h2>
                    </div>
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex justify-center left-5 right-5 bottom-5">
                        <h2 className='bg-gradient-to-r from-blue-200 to-fuchsia-500 px-10 py-1 text-4xl font-mono brightness-50 text-white font-extrabold'>Sports cars</h2>
                    </div>
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                ...
                <div id="slide3" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex justify-center left-5 right-5 bottom-5">
                        <h2 className='bg-gradient-to-r from-blue-500 to-fuchsia-200 px-10 py-1 text-4xl font-mono brightness-50 text-white font-extrabold'>Sports cars</h2>
                    </div>
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a href="#slide2" className="btn btn-circle">❮</a>
                        <a href="#slide4" className="btn btn-circle">❯</a>
                ...
                <div id="slide4" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex justify-center left-5 right-5 bottom-5">
                        <h2 className='bg-gradient-to-r from-blue-300 to-fuchsia-400 px-10 py-1 text-4xl font-mono brightness-50 text-white font-extrabold'>Sports cars</h2>
                    </div>
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a href="#slide3" className="btn btn-circle">❮</a>
                        <a href="#slide1" className="btn btn-circle">❯</a>
