        ...
        <div>
           <Title title={"Location"}/>
            <section className="dark:bg-gray-800 dark:text-gray-100 font-body">
                <div className="container w-full flex flex-col md:flex-row justify-center justify-content-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
          ...
          <div>
            ...
            <div className="text-xl font-semibold font-sans -mt-1">Google Play</div>
                        ...
                        <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-between my-5">
                            <Link rel="noopener noreferrer" href="#" className="px-8 py-3 text-lg font-semibold border rounded dark:border-rose-500 hover:bg-rose-500 focus:bg-rose-500">Location</Link>
                            <Link rel="noopener noreferrer" href="#" className="px-8 py-3 text-lg font-semibold border rounded dark:border-rose-500 hover:bg-rose-500 focus:bg-rose-500">Contacts</Link>
