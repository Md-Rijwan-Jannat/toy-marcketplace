...
const OurNextShop = () => {
    useEffect(() => { Aos.init() }, [])
    return (
        <div className='bg-base-200 rounded-2xl py-24 px-5 shadow-2xl '> 
            <div data-aos="fade-up"
                data-aos-duration="3000" className='flex flex-col justify-center items-center w-full mb-16'>
                <h2 className='text-3xl text-primary style flex flex-col items-center'><span>Our Shop locatioN </span><FaCar className='ml-3 my-5 text-5xl'></FaCar></h2>
                <hr className='w-1/3' />
            </div>
            <div className='md:flex m-5 my-24 items-center justify-center space-y-10'>
                <div data-aos="zoom-in-up" className='bg-blue-100 rounded-3xl p-4 md:p-10 flex flex-col justify-center h-1/2'>
                ...
                <div className='md:flex flex-col'>
                    <div data-aos="zoom-in-up" className='bg-purple-100 rounded-3xl p-4 md:p-10'>
                    ...
                    <div data-aos="zoom-in-up" className='bg-red-100 rounded-3xl p-4 md:p-10 mt-16'>
