...
const OurNextShop = () => {
    useEffect(() => { Aos.init() }, [])
    return (
        <div className='md:flex m-5 my-24 items-center justify-center bg-base-200 rounded-2xl py-24 px-5 shadow-2xl space-y-10'>
            ...
            <div className='flex flex-col'>
                <div data-aos="fade-down-left" className='bg-purple-100 rounded-3xl p-4 md:p-10'>
                ...
                <div data-aos="fade-up-left" className='bg-red-100 rounded-3xl p-4 md:p-10 mt-16'>
