...
const Details = () => {
    ...
    const { photo, toyName, sellerName, quantity, category, price, rating, description, email } = toyDetails;
    return (
        <div>
            ...
            <div data-aos="fade-right"
                ...
                <div className='md:w-full'>
                    <div className='space-y-2  px-5 md:p-16'>
                        ...
                        <div className='text-lg text-orange-400 font-bold flex items-center justify-end px-10'>
