    ...
    <React.Fragment>
      <Container>
        <div className="relative w-full">
          <nav
            className={`max-w-[1400px] mx-auto px-4 py-7 flex justify-between items-center fixed w-full z-[999] ${
          ...
          <div>
            <ul>
              <li className="mb-1">
                <NavLink
                  to="/"
                  className="block p-4 text-sm font-semibold text-gray-400 hover:bg-rose-50 hover:text-rose-600 rounded uppercase"
                >
                  Home
                </NavLink>
              </li>
